...
#include <Python.h>
/**
 * print_python_bytes -The function that  print some basic info about Python bytes objects
 * @p: python object
 * Return: nothing
 **/
...
/**
 * print_python_list - The function that print some basic info about Python lists
 * @p: python object
 * Return: nothing
 **/

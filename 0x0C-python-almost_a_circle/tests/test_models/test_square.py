#!/usr/bin/python3
'''Defining unit-tests for models/square.py.
'''
import io
import sys
import unittest
...
class TestSquare_size(unittest.TestCase):
    '''unit-tests class for testing size initialization of the Square class.'''
...
class TestSquare_x(unittest.TestCase):
    '''unit-test class for testing initialization of Square x attribute.'''
...
class TestSquare_y(unittest.TestCase):
    '''unit-test class for testing initialization of Square y attribute.'''
...
class TestSquare_area(unittest.TestCase):
    '''unit-test class for testing the area method of the Square class.'''
...
class TestSquare_stdout(unittest.TestCase):
    '''unit-test class for testing __str__ and display methods of Square class.'''
    ...
    def capture_stdout(sq, method):
        ...
        Arguments:
            sq (Square): The Square that print to stdout.
...
class TestSquare_update_args(unittest.TestCase):
    '''unit-test class for testing update args method of the Square class.'''
...
class TestSquare_update_kwargs(unittest.TestCase):
    '''unit-test class for testing update kwargs method of Square class.'''
...
class TestSquare_to_dictionary(unittest.TestCase):
    '''unit-test class for testing to_dictionary method of the Square class.'''

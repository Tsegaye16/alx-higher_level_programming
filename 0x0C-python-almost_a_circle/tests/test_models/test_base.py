...
import os
'''
module that contains all unittest for base class
'''


class Test_base(unittest.TestCase):
    '''
    This class contain methods to run tests
    '''
    def set_up(self):
        '''
        this method used to redirect stdout
        '''
        sys.stdout = StringIO()

    def tear_down(self):
        '''
        this method used to clean everything
        '''
        sys.stdout = sys.__stdout__

    def test_for_pep8_model(self):
        '''
        this method used to test pep8
        for `models/base.py
        '''
    ...
    def test_pep8_test(self):
        '''
        this method used to test
        pep8 for `tests/test_models/test_base.py`
        '''
        p8 = pep8.StyleGuide(quiet=True)
    ...
    def test_id(self):
        '''
        This method used to check for id 
        '''
    ...
    def test_from_json_string(self):
        '''
        This method used to check from json string
        '''
    ...
    def test_square(self):
        '''
        This method useds to test check for square creation
        '''
        S1 = Square(33, 44, 55, 66)

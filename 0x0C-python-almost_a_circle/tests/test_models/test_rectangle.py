#!/usr/bin/python3
'''Defining unit-test for models/rectangle.py.
'''
import io
import sys
import unittest
...
class TestRectangle_instantiation(unittest.TestCase):
    '''unit-test class for testing instantiation of the Rectangle class.'''
...
class TestRectangle_width(unittest.TestCase):
    '''unit-test class to testing initialization of Rectangle width attribute.'''
...
class TestRectangle_height(unittest.TestCase):
    '''unit-test class to testing initialization of Rectangle height attribute.'''
...
class TestRectangle_x(unittest.TestCase):
    '''unit-test class to testing initialization of Rectangle x attribute.'''
...
class TestRectangle_y(unittest.TestCase):
    '''unit-test class to testing initialization of Rectangle y attribute.'''
...
class TestRectangle_order_of_initialization(unittest.TestCase):
    '''unit-test class to testing Rectangle order of attribute initialization.'''
...
class TestRectangle_area(unittest.TestCase):
    '''unit-test class to testing the area method of the Rectangle class.'''
...
class TestRectangle_stdout(unittest.TestCase):
    '''unit-test class to testing __str__ and display methods of Rectangle class.'''

    @staticmethod
    def capture_stdout(rect, method):
        '''the method that captures and
...
class TestRectangle_update_args(unittest.TestCase):
    '''unit-test class to testing update args method of the Rectangle class.'''
...
class TestRectangle_update_kwargs(unittest.TestCase):
    '''unit-test class to testing update kwargs method of the Rectangle class.'''
...
class TestRectangle_to_dictionary(unittest.TestCase):
    '''unit-test class to testing to_dictionary method of the Rectangle class.'''
